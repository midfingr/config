...
$('#reset_form').submit(function (evt) {
    ...
    $.ajax({
      ...
      success: function(msg){
            $('#reset_alert').html('<p class="no_error">Your password has been changed. You can log in to <a href="https://tweetdeck.twitter.com">the web app</a> or in your client.</p>');
